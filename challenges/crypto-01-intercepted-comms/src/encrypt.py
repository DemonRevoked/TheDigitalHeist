...
def aes_encrypt(plaintext, key):
    ...
    iv = b'0000000000000000'  # 16 bytes of zeros - easier for CyberChef
...
def main():
    ...
    # Generate AES key - simple 16-byte key for AES-128
    # Use "HEIST" + first 11 chars of challenge_key, pad to 16 bytes
    key_part = challenge_key[:11] if len(challenge_key) >= 11 else challenge_key + 'X' * (11 - len(challenge_key))
    aes_key = ("HEIST" + key_part)[:16]  # Exactly 16 bytes
